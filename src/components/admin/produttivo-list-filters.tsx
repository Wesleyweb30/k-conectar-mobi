...
export default function ProduttivoListFilters({ basePath, members }: Props) {
  ...
  }, [router, basePath, startDate, endDate, userId]);
  ...
  const hasActiveFilters =
    searchParams.has("startDate") || searchParams.has("endDate") || searchParams.has("userId");
